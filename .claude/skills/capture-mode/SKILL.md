...
> - any work spoke if work content surfaces (Redacted / Taskforce / a side project)
>
...
- If user mentions a work topic (Redacted, Taskforce, a specific side project), record the cross-route hint.
