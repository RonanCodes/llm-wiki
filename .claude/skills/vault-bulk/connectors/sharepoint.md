...
2. **Work plugin connector**: `redacted:sharepoint`, `<employer>:sharepoint`, or any `*:sharepoint` skill provided by a plugin the user has loaded.
...
> Options:
>
> 1. If your work plugin provides one (e.g. on your work machine you may have `redacted:sharepoint`), enable that plugin in this session.
