...
| Official-work engineering at the current employer | _(private; see `.private/docs/`)_ | Spoke | Employer-specific routing is kept out of this public repo. The vault and its routing note live privately |
